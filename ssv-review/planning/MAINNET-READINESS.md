...
**Updated:** 2026-03-12 (closed OPS-3 with v2.0.0 env template refresh)
...
| OPS-3 | ~~Update `.env.example` for v2.0.0~~ | Operational Readiness | P2 | ✅ Closed (v2 env template + fork/test overrides) |
