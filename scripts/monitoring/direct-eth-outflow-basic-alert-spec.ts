...
export function buildDirectEthOutflowBasicAlertSpec(): DirectEthOutflowBasicAlertSpec {
  ...
  return {
    ...
    deployment,
    intent: "Start with simple event alerts for direct ETH leaving the Hoodi stage SSVNetwork proxy.",
    assumptions: [
      "This starter pack is limited to direct ETH-outflow functions only.",
