...
describe('SSV Network', function () {
  ...
  it('Operator and validator balances', async function () {
    const testFlow = {
      10: {
        funcs: [
          ...
          () => registerOperator([
            ...
            { account: account1, idx: 2, fee: 10000000 },
      ...
      20: {
        funcs: [
          () => registerValidator([{ account: account1, validatorIdx: 0, operatorIdxs: [0, 1, 2, 3], depositAmount: 99000000000000 },])
        ],
        asserts: [
      ...
      40: {
        funcs: [
          () => registerValidator([{ account: account1, validatorIdx: 2, operatorIdxs: [0, 1, 2, 3], depositAmount: 99000000000000 },])
        ],
        asserts: [
          () => checkOperatorBalances([0, 1, 2, 3]),
          () => checkNetworkTreasury()
      ...
      50: {
        funcs: [
          () => registerValidator([{ account: account1, validatorIdx: 3, operatorIdxs: [0, 1, 2, 3], depositAmount: 99000000000000 },])
        ],
        asserts: [
          () => checkOperatorBalances([0, 1, 2, 3]),
