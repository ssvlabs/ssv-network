...
const MAX_GAS_PER_GROUP: any =
  process.env.IS_TEST_SOL_COV === '1' ? {
    ...
    [GasGroup.REGISTER_VALIDATOR_EXISTING_POD]: 226000,
    [GasGroup.REGISTER_VALIDATOR_EXISTING_CLUSTER]: 243000,
    [GasGroup.REGISTER_VALIDATOR_NEW_STATE]: 319000,
    [GasGroup.REMOVE_VALIDATOR]: 147000,
    [GasGroup.TRANSFER_VALIDATOR_NEW_CLUSTER]: 400000,
    [GasGroup.TRANSFER_VALIDATOR]: 276000,
    [GasGroup.TRANSFER_VALIDATOR_NON_EXISTING_POD]: 290000,
    [GasGroup.BULK_TRANSFER_VALIDATOR]: 437000,
    [GasGroup.BULK_TRANSFER_VALIDATOR_NON_EXISTING_POD]: 454000,
    [GasGroup.DEPOSIT]: 82500,
    [GasGroup.WITHDRAW]: 110000,
    [GasGroup.REGISTER_POD]: 147000,
    [GasGroup.LIQUIDATE_POD]: 186000,
    [GasGroup.REACTIVATE_POD]: 197000,
  } : {
    /* REAL GAS LIMITS */
    [GasGroup.REGISTER_OPERATOR]: 105000,
    [GasGroup.REMOVE_OPERATOR]: 45000,
