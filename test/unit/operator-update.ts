...
describe('Operator Update', function () {
  ...
  it('Revert fee doesnt work', async function () {
    ...
    // Try to revert fee
    await expect(ssvNetwork.connect(account2).declareOperatorFee(operatorsIds[0], 1000000)).to.be.revertedWith('fee exceeds increase limit')
  })
