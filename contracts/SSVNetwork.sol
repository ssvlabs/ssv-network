...
contract SSVNetwork is OwnableUpgradeable, ISSVNetwork {
    ...
    */
    ...
    function deposit(
        ...
        emit ClusterDeposited(msg.sender, operatorIds, amount, cluster);
    }
    ...
    function withdraw(
        ...
        emit ClusterFundsWithdrawal(msg.sender, operatorIds, amount, cluster);
    }
